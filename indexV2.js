...
inquirer
    ...
    .then(function (userInput) {
        ...
        fs.writeFile(githubUsername, JSON.stringify(userInput, null, '\t'), function (err) {
            ...
            //========================================
            // Generate HTML? Then grab axios info
            //========================================
            function generateHTMLFunction() {
                try {
                    //====================================================================
                    // These are the functions that perform axios requests.
                    //====================================================================
                    githubQuery(queryUrl);
                    //===============================================
                    // This will write the info into the HTML file.
                    //===============================================
                    await writeFileAsync(`${userInput.username}.json`, `utf8`).then(function (data) {
                        generateHTMLjs.generateHTML();

                    });
                    //====================================================================
                    // This grabs the stars.
                    //====================================================================
